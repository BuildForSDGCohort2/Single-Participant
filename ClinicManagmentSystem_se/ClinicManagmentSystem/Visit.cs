   ...
   public class Visit
    {
       ...
       public string reasons, diagnos, notes;
        public Visit(int visit_id,int patient_id,string patient_name,int secretary_id,string secretary_name,int doctor_id,string doctor_name,DateTime date,string reasons,string diagnos,string notes)
        {
