...
namespace ClinicManagmentSystem.UI
{
    public partial class Visits : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please enter a reasons and dignosis");
                return;
            }
            ...
            {
                MessageBox.Show("Visit was added successfully");
            }
            else
            {
                MessageBox.Show("Visit was not added successfully");
            }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (command.ExecuteNonQuery() > 0 )
            {
                ...
                MessageBox.Show("Visit was updated successful");

            }
            else
            {
                MessageBox.Show("Visit was not  updated");
            }
        ...
        private void deletePatient_Click(object sender, EventArgs e)
        {
            ...
            command = con.CreateCommand();
            command.CommandText = "DELETE FROM visit WHERE visit_id = @id";
            command.Parameters.AddWithValue("@id", textBox4.Text);
            con.Open();
            if (command.ExecuteNonQuery() > 0)
            {
                MessageBox.Show("Visit was deleted successfully");
            ...
            {
                MessageBox.Show("Visit failed to be deleted");
            }
            con.Close();
