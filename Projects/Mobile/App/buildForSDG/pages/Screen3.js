  ...
  render() {
    return (
      <View style={styles.MainContainer}>
        ...
        <View>
          <Text style={styles.text}>You can textus direct from yyour phone.We are ready to help you.</Text>
          <Image
          ...
          />
          <Text style={styles.text}>Send BuildforSDG SMS</Text>
          </View>
        </TouchableOpacity>
      </View>
    );
