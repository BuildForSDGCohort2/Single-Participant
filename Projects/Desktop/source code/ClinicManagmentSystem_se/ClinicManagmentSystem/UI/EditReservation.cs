...
namespace ClinicManagmentSystem.UI
{
    public partial class EditReservation : Form
    {
        ...
        public EditReservation(Reservation res)
        {
            ...
            updateCombobo(res.slot);

        }


        private void updateCombobo(int visit_slot)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Fail to update the reservation !");
            }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            if(command.ExecuteNonQuery()>0)
                MessageBox.Show("Reservation was deleted successfully");
            else
                MessageBox.Show("Reservation failed to be deleted");
            con.Close();
        }
